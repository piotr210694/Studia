							...
							<div id="collapseOne" class="panel-collapse collapse in">
								<div class="panel-body">
									<table class="table">
										...
										<tr>
											<td>
												<span class="glyphicon glyphicon-file text-info"></span><a href="articleManageKat.php">Przeglądaj</a>
											</td>
										</tr>
									</table>
								</div>
				...
				<div class="col-sm-9 col-md-9">
					<div class="well">	
						...
						<div class="form-group">
							...
							<p class="text-right">Chcesz dodać kategorię? <a href="" >Kliknij tutaj</a></p>
							<div class="form-group"  >
								<label >Tytuł</label>
