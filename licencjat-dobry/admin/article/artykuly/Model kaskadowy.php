...
<!-- KONIEC SLIDER -->	
            ...
            <div class="row">
				<div class="col-md-12"><h1>Model kaskadowy</h1><b>Model kaskadowy</b> - zwany <i>wodospadowym</i> (ang. <i>waterfall</i>) jest chyba najbardziej klasycznym przykładem <i>modelu cyklu życia oprogramowania</i>. Niezwykle zachęcającym argumentem do skorzystania z tego wzorca jest fakt, iż jest on zgodny z naturą człowieka. Tak samo jak ludzie rozwiązują swoje problemy krok po kroku, tak samo tutaj cykl życia oprogramowania jest przedstawiony w sposób liniowy. Kolejne fazy wykonywane są kolejno -- jedna po drugiej. W tym modelu wyjście z jednego etapu jest ściśle powiązane z wejściem w kolejny, bowiem nie mamy możliwości powrotu.<br> Przykład modelu wodospadowego znajduje się w galerii. Podział ten może różnić się od zaprezentowanego (w zależności od autora może być mniej lub bardziej szczegółowy).<br><hr>
