...
<!-- KONIEC MENU-->
            ...
            <div class="row">
				...
				<form action="php/connectionRegistration.php" method="post" role="form">
				<label >Login:</label>
				<div class="form-group"  >
						<input required type="text" class="form-control" name="login" placeholder="Podaj login">
				</div>
				<label >Hasło:</label>
				<div class="form-group"  >
						<input required type="password" class="form-control" name="pass" placeholder="Podaj hasło">
				</div>
				<label >Potwierdź hasło:</label>
				<div class="form-group"  >
						<input required type="password" class="form-control" name="pass2" placeholder="Podaj hasło ponownie">
				</div>
				<label >Email:</label>
				<div class="form-group"  >
						<input required type="email" class="form-control" name="email" placeholder="Podaj email">
				</div>				
						<button type="submit" class="btn btn-success pull-left btn-block">OK</button>
						<div class="form-group" >
						<?php 
							if(isset($_SESSION['komunikatA']))
							{
								echo $_SESSION['komunikatA'];
							}if(isset($_SESSION['komunikatB']))
							{
								echo $_SESSION['komunikatB'];
							}
						?>
						</div>
				</form>			
