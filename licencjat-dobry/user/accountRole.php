  ...
  <li><a href='../contact/kontakt.php'><span>Kontakt</span></a></li>
   ...
   <li class='last active has-sub' ><a><span><img src="data:image/png;base64,"/></span></a>
		<ul>
			...
			<li><a href='accountRole.php'><span>Typ konta</span></a></li>
...
<!-- WALIDACJA --> 
            ...
            <div class="row">
				...
				<div class="col-md-6 text-center">
					<p>
						<?php echo '<span style="color: green; text-transform: uppercase;">'.$_SESSION['login'].'</span>'; ?> twój obecny typ konta to:  
						<?php
							if ($_SESSION['rola'] == 'root')
							{
								echo '<b>'."Administrator".'</b>';
							}
							else if ($_SESSION['rola'] == 'user')
							{
								echo '<b>Zwykły użytkownik</b>';
							}
							...
							{
								echo "Wystąpił błąd z określeniem typu konta!";
							}
						?>
					</p>	
					<hr>
					<p>
						Jeśli chcesz zmienić typ konta, poproś o zmianę:
					</p>
					
					<form action="php/requestType.php" method="post" role="form">
						<div class="form-group">
							...
							<p>
							<button type="submit" class="btn btn-success pull-left btn-block">Wyśli prośbę</button></p>		
						</div>
					</form>
					<br>
					<br>
					<div class="text-left" style="">
						<?php
							if(isset($_SESSION['komunikatRoli']))
							{
								echo $_SESSION['komunikatRoli'];
							}
						?>
					</div>
